...
public class MenuItemView extends CompareIntegerId implements Serializable, GetableById<Integer> {
    ...
    private Integer parent_menu_item;
    ...
    public Integer getParent_menu_item() {
        return parent_menu_item;
    }

    public void setParent_menu_item(Integer parent_menu_item) {
    ...
    public boolean equals(Object o) {
        ...
        if (parent_menu_item != null ? !parent_menu_item.equals(that.parent_menu_item) : that.parent_menu_item != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (parent_menu_item != null ? parent_menu_item.hashCode() : 0);
