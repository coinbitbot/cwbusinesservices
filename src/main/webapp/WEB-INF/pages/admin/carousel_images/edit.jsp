...
<html ng-app="edit">
<head>
    <title>Edit carousel image #${id}</title>
</head>
<body>
    <jsp:include page="../header.jsp" />
    <div class="container col-md-10 col-md-offset-1" ng-controller="edit_forms">
        <div class="top-nav">
            <a href="/admin/carousel_images/all"><i class="fa fa-long-arrow-left" aria-hidden="true"></i>Back to all carousel images</a>
        </div>
        <div class="page-title">Create / Edit carousel image</div>
        <form ng-submit="save();">
...
<script src="/resources/js/admin/carousel_images/edit.js?id=${id}" id="loader"></script>
</body>
</html>
