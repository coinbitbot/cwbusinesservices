(function(){
    ...
    function preload() {
        ...
        game.load.image('paddle', '/resources/js/game/images/paddle.png');
        game.load.image('brick', '/resources/js/game/images/brick.png');
        game.load.spritesheet('ball', '/resources/js/game/images/wobble.png', 20, 20);
        game.load.spritesheet('button', '/resources/js/game/images/button.png', 120, 40);
    }
